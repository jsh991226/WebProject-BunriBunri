...
<body>
	...
	<input type="button" class="btn btn-primary" onClick='$("#mainView").load("./board.jsp")'style="width: 100%;height: 40px;margin-bottom:40px;" value="목록으로 돌아가기" />
				...
				<table class="table table-striped"
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control form-control-plaintext whiteinput" readonly id="postTitle" maxlength="50"/></td>

						</tr>
				
						<tr>
							<td><input type="text" class="form-control form-control-plaintext whiteinput" readonly id="postWriter" maxlength="50"/></td>
							<td><input type="text" class="form-control form-control-plaintext whiteinput" readonly id= "postDate" maxlength="50"/></td>
							<td><input type="text" class="form-control form-control-plaintext whiteinput" readonly id="postView" maxlength="50"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3"><textarea class="form-control form-control-plaintext whiteinput" readonly id="postContent" maxlength="2048" style="height: 350px;"></textarea></td>
